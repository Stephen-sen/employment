            ...
            <div class="content main-page-190">
                <div class="margin-lr-1">
                    <div class="main-page-90 over-flow-x-hidden">
                       <form id="form1" action="${path}/stuAbiController/reAnalysis.do" method="post">
                        ...
                        <table class="add-tb">
                                <tr>
                       			...
                       			<tr>
                                    ...
                                    <td class="rtd4">
                                        <input id="telTxt" autocomplete="off" type="text"  name="student.tel"value="${user.tel}" class="width-p40"style="background-color: #E6E9F0" readonly="readonly"/>
                                    </td>
                                 </tr>
                                 <tr>
                                ...
                                <tr>
                                   ...
                                   <tr>
                                    ...
                                    <td class="rtd4">
                                    <input id="scoreKeyTxt${posAbiList.ability.id}" type="hidden" name="scoreKeyArray" value="${posAbiList.ability.id}"/>
                                  	<select id="${posAbiList.ability.id}"  name="scoreValArray" class="required width-p40">
